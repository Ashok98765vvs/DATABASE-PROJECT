        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="left">
                    <h1 style="padding-left:15px;">THE TAJ</h1>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <!-- <li><a href="#" class="waves-effect waves-block waves-light"><i class="mdi-editor-attach-money"><?php echo $balance;?></i></a>
                        </li> -->
                        <li><a href="#" class="waves-effect waves-block waves-light"><?php echo "Rs.".$balance;?></i></a>
                        </li>
                    </ul>						
                </div>
            </nav>
...
?>
  ...
  <!-- <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © aaaa <a class="grey-text text-lighten-4" href="#" target="_blank">ashok</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Ashok</a></span>
        </div>
    </div>
  </footer> -->
    <!-- END FOOTER -->
