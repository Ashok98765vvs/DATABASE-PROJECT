    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="ordercount.php" class="waves-effect waves-cyan"><i class="mdi-editor-format-list-numbered"></i>Order Count</a>
            
            <?php
            $pdo = new PDO("mysql:host=$servername;dbname=$dbname", $server_user, $server_pass);
            // execute the stored procedure
            $sql = 'CALL orders_count()';
